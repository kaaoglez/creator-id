        ...
        <div style={{ 
          ...
          >
            <svg width="40" height="40" viewBox="0 0 24 24" fill="#000">
              <path d="M17.05 20.28c-.98.95-2.05.88-3.08.37-1.09-.5-2.08-.5-3.2 0-1.2.55-2.04.42-3.02-.37C4.08 16.25 4.96 9.9 8.9 9.5c1.14-.07 1.98.76 2.68.76.7 0 1.88-.93 3.2-.76 1.36.13 2.5.96 3.1 2.27-2.8 1.67-2.3 5.17.41 6.51-.3.88-.7 1.72-1.14 2.5zM14.4 4.5c.07 1.34-.78 2.64-2.08 2.86-.1.05-.2.08-.31.08-.15 0-.3-.05-.44-.1.12-1.33.85-2.54 2.04-2.96.16-.06.32-.1.48-.1.11 0 .22.02.31.05v.07z"/>
            </svg>
          </button>
        </div>
